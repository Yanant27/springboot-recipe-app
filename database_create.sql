...
create table recipe (id bigint not null auto_increment, cook_time integer, description varchar(255), difficulty varchar(255), direction longtext, image longblob, prep_time integer, serving integer, source varchar(255), url varchar(255), note_id bigint, primary key (id)) engine=InnoDB;
