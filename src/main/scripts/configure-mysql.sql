...
CREATE USER 'recipe_dev_user'@'localhost' IDENTIFIED BY 'yanant27';
CREATE USER 'recipe_prod_user'@'localhost' IDENTIFIED BY 'yanant27';
CREATE USER 'recipe_dev_user'@'%' IDENTIFIED BY 'yanant27';
CREATE USER 'recipe_prod_user'@'%' IDENTIFIED BY 'yanant27';
# "%" means wild card for local host because host may come in different IP address
