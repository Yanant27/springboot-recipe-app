package hyk.springframework.springbootrecipeapp.bootstrap;

import hyk.springframework.springbootrecipeapp.models.*;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        // Add categories to guacRecipe
        guacRecipe.getCategories().add(americanCategory);
        guacRecipe.getCategories().add(mexicanCategory);

        // Add guacRecipe to return list
    ...
    /**
     * Check expected category is available or not.
