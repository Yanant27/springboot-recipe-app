...
import hyk.springframework.springbootrecipeapp.commands.IngredientCommand;
...
import hyk.springframework.springbootrecipeapp.services.IngredientService;
import hyk.springframework.springbootrecipeapp.services.RecipeService;
import hyk.springframework.springbootrecipeapp.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String listIngredients(@PathVariable String recipeId, Model model){
        ...
        model.addAttribute("recipe", recipeService.findCommandById(
